...
export default function Today({ totals, goal, progress, remaining, pace, calorieProgress, waterMl, waterGoal, onAddWater, waterUndo, onUndoWater, waterError, mealGroups, suggestion, onDelete, onSelect, dayLabel, isToday, onToday, onPrev, onNext, canPrev, canNext }) {
