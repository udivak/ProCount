...
export default function Today({ totals, goal, remaining, entries, onDelete, onSelect, dayLabel, onPrev, onNext, canPrev, canNext }) {
  ...
  return <div className="today-neon">
    <div className="today-daybar"><DayArrow chevron="›" label="יום קודם" disabled={!canPrev} onClick={onPrev} /><div className="today-daylabel">{dayLabel}</div><DayArrow chevron="‹" label="יום הבא" disabled={!canNext} onClick={onNext} /></div>
