...
const calories = (value) => Number(value || 0).toLocaleString("he-IL");

export default function Today({ totals, goal, progress, remaining, pace, calorieProgress, calorieIntake, calorieGoal, calorieBalance, waterMl, waterGoal, onAddWater, waterUndo, onUndoWater, waterError, mealGroups, suggestion, onDelete, onSelect, dayLabel, isToday, onToday, onPrev, onNext, canPrev, canNext }) {
